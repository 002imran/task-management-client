                    ...
                    <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-20 ' : 'top-[-490px]'}`}>
                        ...
                        <li>
                            <div className="mr-14 sm:ml-0">
                                <input type="text" id="success" onKeyDown={handleKeyDown} className="bg-green-50 border border-green-500 text-green-900 dark:text-green-400 ml-2
                             placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 
                             block w-full p-2.5 dark:bg-gray-700
                              dark:border-green-500" placeholder="Input a task" to='/mytask' />
